...
docker compose exec -u postgres postgres-primary psql -d app_development -c "INSERT INTO ynars (content, created_at, updated_at) VALUES ('Manual Lag Check at $(date)', NOW(), NOW());"
